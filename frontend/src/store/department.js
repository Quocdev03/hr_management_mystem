...
export const useDepartmentStore = defineStore("department", () => {
	...
	async function fetchDepartments(params = {}) {
		...
		try {
			...
			return {
				success: false,
				message: error?.message || "Lỗi tải danh sách phòng ban",
			};
		} finally {
			loading.value = false;
		}
	...
	async function createDepartment(data) {
		try {
			...
			return {
				success: false,
				message: error?.message || "Lỗi tạo phòng ban",
			};
		}
	}
	...
	async function updateDepartment(id, data) {
		try {
			...
			return {
				success: false,
				message: error?.message || "Lỗi cập nhật phòng ban",
			};
		}
	}
	...
	async function deleteDepartment(id) {
		try {
			...
			return {
				success: false,
				message: error?.message || "Lỗi xoá phòng ban",
			};
		}
	}
